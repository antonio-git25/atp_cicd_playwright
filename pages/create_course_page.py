...
class CreateCoursePage(BasePage):
    ...
    def fill_create_course_form(
            self, title: str, estimated_time: str, description: str, max_score: str,
            min_score: str):
    ...
    def click_delete_exercise_button(self, index: int):
        ...
        # В дальнейшем мы будем использовать паттерн PageFactory для динамических элементов на странице.
